...
### 2. [Static Website Hosting on S3](./static-website-s3/)
...
### 3. [Cloud Security with IAM](./IAM-cloud-security/)
...
### 4. [Build your own Virtual Private Cloud](./virtual-private-cloud/)
...
### 5. [VPC Traffic Flow and Security](./vpc-traffic-flow-security/)
...
### 6. [VPC Private Subnets](./vpc-private-subnet/)
...
### 7. [Launching VPC Resources](./vpc-launching-resources/)
...
### 8. [Testing VPC Connectivity](./vpc-testing-connectivity/)
...
### 10. [VPC Monitoring with Flow Logs](./vpc-monitoring/)
...
### 11. [S3 Access from VPC](./s3-from-vpc/)
...
### 13. [EC2 Web App with Aurora DB](./aurora-db-ec2/)
